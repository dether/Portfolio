	...
	return (
		<section className="home" id="home">
			<div className="home-content">
				...
				<h3>y soy{" "}
					<span className="multiple-text" style={{ display: "inline-block" }} translate="no">
						<Typewriter
							options={{
				...
				<div className="social-media">
					...
					<a
						href="https://wa.me/+5493644270614"
						target="_blank"
						rel="noopener noreferrer"
					>
					...
					*/}
					...
					<a
						href="https://www.linkedin.com/in/alejandro-gabriel-vargas-b81445267/"
						target="_blank"
						rel="noopener noreferrer"
					>
				...
				<a
					href="https://drive.google.com/file/d/14lle2in7EzBBjH25-i3qdmTbj8hCT06f/view?usp=sharing"
					target="_blank"
					rel="noopener noreferrer"
					className="btn"
				>
